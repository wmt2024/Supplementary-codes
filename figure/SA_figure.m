...
values = [1.25, 2.35, 0.6, 1.11, 1.06, 1.18, 2.31];
...
exportgraphics(f, 'radar_chart.tif', 'Resolution', 1000, 'ContentType', 'image');
disp('High-resolution TIFF radar chart saved as radar_chart.tif (1000 DPI)');
